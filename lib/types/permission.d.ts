...
export type PermissionsReaderOne<T extends Entity> = (filters: DSO<T>) => PermissionsForEntity<T>;
export type PermissionsReaderMany<T extends Entity> = (filters: DSO<T>) => PermissionsForEntity<T>[];
export {};
